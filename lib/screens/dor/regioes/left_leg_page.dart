...
class LeftLegPage extends StatefulWidget {
  const LeftLegPage({super.key});

  @override
  State<LeftLegPage> createState() => _LeftLegPageState();
}
          ...
          Expanded(
            child: Padding(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    'Região da Perna Esquerda - Em desenvolvimento',
