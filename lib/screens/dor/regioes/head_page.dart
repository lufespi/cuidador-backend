...
class _HeadPageState extends State<HeadPage> {
  ...
  // Pontos detalhados da cabeça
  final List<Map<String, dynamic>> _pontosDetalhados = [
    // TODO: Adicionar pontos detalhados da região da cabeça
  ];
          ...
          Expanded(
            child: Padding(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    'Região da Cabeça - Em desenvolvimento',
